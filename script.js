...
Terima kasih udah jadi "just friend" aku yang paling berharga. Kamu bener-bener bikin hari-hari aku jadi lebih bahagia rasanya ga perna ngerasain yg namanya kesepian lagi. Semoga di tahun yang baru ini, kamu makin bahagia, makin sukses, dan tentunya makin semangat berubah (walaupun gwe cape ngingetin mulu🤬!).
...
function skipTypewriter() {
    if (isTyping && typewriterInterval) {
        ...
        const messageContent = document.querySelector('.message-content');
        if (messageContent) {
            const fullMessage = `Hi Cel,<br><br>Happy Birthday!<br><br>Hari ini aku pengen kamu ngerasain semua hal positif dan keajaiban yang cuma bisa didapetin kalo kamu ada di dunia ini. Semoga segala keinginanmu tercapai, apalagi yang kocak-kocak dan gak biasa, karena kamu tuh unik banget! Aku selalu percaya kalau kamu bisa melewati semua tantangan dengan kekuatan dan semangat yang luar biasa.<br><br>Terima kasih udah jadi "just friend" aku yang paling berharga. Kamu bener-bener bikin hari-hari aku jadi lebih berarti dan rasanya ga pernah ngerasain yang namanya kesepian. Semoga di tahun yang baru ini, kamu makin bahagia, makin sukses, dan tentunya makin semangat berubaahh (walaupun gwe udah cape ngingetin mulu🤬!).<br><br>I love you so much! 💕`;
